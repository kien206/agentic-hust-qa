...
# Import your models
from ..db_schema import Base, Lecturer, LecturerEmail, LecturerEducation, LecturerResearch, \
                      LecturerInterest, LecturerPublication, LecturerAward, \
                      LecturerSubject, LecturerProject
...
def insert_lecturer_data(engine, lecturer_data):
    ...
    try:
        ...
        for interest in lecturer_data.get("interested_field", []):
            lecturer_interest = LecturerInterest(lecturer_id=lecturer.id, interest=interest)
