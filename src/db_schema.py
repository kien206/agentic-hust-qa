...
class Lecturer(Base):
    ...
    # Relationships
    emails = relationship("LecturerEmail", back_populates="lecturer", cascade="all, delete-orphan")
    education = relationship("LecturerEducation", back_populates="lecturer", cascade="all, delete-orphan")
    research_fields = relationship("LecturerResearch", back_populates="lecturer", cascade="all, delete-orphan")
    interested_fields = relationship("LecturerInterest", back_populates="lecturer", cascade="all, delete-orphan")
    publications = relationship("LecturerPublication", back_populates="lecturer", cascade="all, delete-orphan")
    awards = relationship("LecturerAward", back_populates="lecturer", cascade="all, delete-orphan")
    teaching_subjects = relationship("LecturerSubject", back_populates="lecturer", cascade="all, delete-orphan")
    projects = relationship("LecturerProject", back_populates="lecturer", cascade="all, delete-orphan")
